        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>index.php/admin/ukpma">UKP MA </a></li>
          ...
          <section class="content">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Form Data Tambah UKP MA</h3>
              </div>
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('index.php/admin/insert_ukpma'); ?>
                <div class="col-lg-4">
