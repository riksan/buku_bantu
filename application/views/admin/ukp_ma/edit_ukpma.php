        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>index.php/admin/ukpma">UKPMA</a></li>
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('index.php/admin/update_ukpma'); ?>
                <?php  
                ...
                <div class="col-lg-4">
                  ...
                  <input type="hidden" name="id" value="<?php echo $data->id_ukpma ?>">
                  <a href="<?php echo base_url(); ?>index.php/admin/ukpma" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
